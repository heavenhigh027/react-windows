...
const SPREADSHEET_ID = '1Nw3UOKfCNLBk8hdu5tnmEyw_mDJWzhTF7qZcx_SYkrE'; 					//from the URL of your blank Google Sheet
const CLIENT_ID = '555384816571-0veg5o5fl5h6jdo5epdkvkdq1fbk4ljg.apps.googleusercontent.com'; 	//from https://console.developers.google.com/apis/credentials
const API_KEY = 'AIzaSyDfx14quJi6YKcYE_qE7GxVZmDDmtRCDho'; 								//https://console.developers.google.com/apis/credentials
const SCOPE = 'https://www.googleapis.com/auth/spreadsheets';									//URL auth spreadsheet scope

//create Form
//create Form Submit
//create Form Submit Function
//bind Submit Function with Constructor Props

export default class ContactForm extends React.Component {
	constructor(props) {								//to tie the form's callback to this class
		super(props);
